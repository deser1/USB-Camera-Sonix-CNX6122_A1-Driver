...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, USBCameraSonixCNX6122A1DriverQueueInitialize)
#endif

NTSTATUS
USBCameraSonixCNX6122A1DriverQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = USBCameraSonixCNX6122A1DriverEvtIoDeviceControl;
    queueConfig.EvtIoStop = USBCameraSonixCNX6122A1DriverEvtIoStop;
...
VOID
USBCameraSonixCNX6122A1DriverEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
...
VOID
USBCameraSonixCNX6122A1DriverEvtIoStop(
    _In_ WDFQUEUE Queue,
    _In_ WDFREQUEST Request,
